      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form" action="menu-sup.php" method="post">
          ...
          <?php
            ...
            $sql = "exec sp_deletepersona '".$varusu."', 
                                          '".$varip."', 
                                          '".$varipers."'";
          ...
          <div class="container-login100-form-btn">
            <a class="login100-form-btn" href="tablapersona-sup.php">Ver Contactos</a>
				...
				<div class="login100-more" style="background-image: url('https://images.unsplash.com/photo-1472417583565-62e7bdeda490?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1887&q=80');">
        </div>
      </div>
    </div>
  </div>
